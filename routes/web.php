...
Route::group(['middleware' => ['user.activated', 'auth']], function () {
    //view routes
    Route::get('/conversations', 'ChatController@index')->name('conversations')->middleware('permission:manage_conversations');
...
Route::get('/clients-support', function () {
    return view('clients-support');
});
