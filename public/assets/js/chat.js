    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        if (data.success === true) {
          ...
          conversationMessages.push(data.data.message); // notificationSound();
      ...
      success: function success(data) {
        ...
        if (data.success == true) {
          ...
          if (remainingUnread > 0) {
            ...
            callAfterAPI = true; // TODO : do not scroll again and again
...
$(document).on('click', '.load-more-archive-conversation', function () {
  ...
  $loader.show();
  isArchiveLoaded = true; //GET Archive conversations list
...
function addMembers(memberUi) {
  ...
  var memberUiList = '<li class="list-group-item group-members-list-chat-select__list-item align-items-center d-flex justify-content-between">' + memberUi + '</li>';
...
module.exports = __webpack_require__(/*! /var/www/supportChat/resources/assets/js/chat.js */"./resources/assets/js/chat.js");
