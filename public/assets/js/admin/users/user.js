  ...
  var tbl = $('#users_table').DataTable({
    ...
    columns: [{
      ...
      data: function data(_data3) {
        var role_name = getRoleName(_data3.roles);
...
module.exports = __webpack_require__(/*! /var/www/supportChat/resources/assets/js/admin/users/user.js */"./resources/assets/js/admin/users/user.js");
